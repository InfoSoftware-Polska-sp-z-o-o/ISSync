...
const colorGrayDark = 'var(--color-gray-dark, #29254f)';
...
const colorPrimary = 'var(--color-primary, #ff6100)';
...
const colorContentBackground = 'var(--color-content-background, #29254f)';
