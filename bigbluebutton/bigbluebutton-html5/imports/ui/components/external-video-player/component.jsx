...
class VideoPlayer extends Component {
  ...
  componentWillUnmount() {
    ...
    if (document.getElementById("externalScreen")) {
  ...
  render() {
    ...
    if (videoUrl && videoUrl.includes("myrtille") && !Session.get('isExternalIsEnabled')) {
      makeCall('stopWatchingExternalVideo');
    }

    if(videoUrl && videoUrl.includes("myrtille") && isPresenter){
      return null;
    }
    else if (videoUrl && videoUrl.includes("myrtille") && !isPresenter) {
      return (
        <iframe sandbox="
              allow-scripts
