...
const messages = defineMessages({
  ...
  addMyrtileControl: {
    id: 'app.myrtilleControl.addGuest',
    description: 'Text for add guest with myrtille access'
  },
  removeMyrtilleControl: {
    id: 'app.myrtilleControl.removeGuest',
    description: 'Text for remove guest from myrtille session'
  },
  userHasMyrtilleControl: {
    id: 'app.myrtilleControl.hasControl',
    description: 'Text for add myrtille control popup',
  },
  userLostMyrtilleControl: {
    id: 'app.myrtilleControl.lostControl',
    description: 'Text for add myrtille control popup',
  },
});
...
class UserListItem extends PureComponent {
  ...
  getUsersActions() {
    ...
    const isMyrtilleEnabled = Session.get('isExternalIsEnabled') === true ? true: false; 
    ...
    const availableActions = [
      ...
      {
        allowed: isMyrtilleEnabled && !isMe(user.userId) && allowedToSetPresenter && isMeteorConnected && !isDialInUser && !showNestedOptions && !allowedToMyrtilleControl,
        key: 'setControl',
        label: intl.formatMessage(messages.addMyrtileControl),
        onClick: () => {
          this.onActionsHide(assignMyrtilleControl(currentUser, user, intl.formatMessage(messages.userHasMyrtilleControl)));
          this.handleClose();
        },
        icon: 'desktop',
        dataTest: 'changeControlAccess',
      },
      {
        allowed: isMyrtilleEnabled && !isMe(user.userId) && allowedToSetPresenter && isMeteorConnected && !isDialInUser && !showNestedOptions && allowedToMyrtilleControl,
        key: 'removeControl',
        label: intl.formatMessage(messages.removeMyrtilleControl),
        onClick: () => {
          this.onActionsHide(removeMyrtilleControl(currentUser, user, intl.formatMessage(messages.userLostMyrtilleControl)));
          this.handleClose();
        },
        icon: 'desktop_off',
        dataTest: 'changeControlAccess',
