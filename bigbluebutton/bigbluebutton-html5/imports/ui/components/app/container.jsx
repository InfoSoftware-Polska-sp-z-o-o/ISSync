...
export default injectIntl(withModalMounter(withTracker(({ intl, baseControls }) => {
  ...
  const shouldShowExternalScreen = MediaService.shouldShowExternalScreen();
  ...
  return {
    ...
    shouldShowPresentation: !shouldShowScreenshare && !shouldShowExternalVideo && !shouldShowExternalScreen,
