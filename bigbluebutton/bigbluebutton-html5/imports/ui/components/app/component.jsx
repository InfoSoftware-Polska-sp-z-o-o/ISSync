...
import ExternalScreenContainer from '../external-screen/container';
...
class App extends Component {
  ...
  componentDidMount() {
    ...
    const initialPresentation = !getFromUserSettings('bbb_hide_presentation', HIDE_PRESENTATION || !layoutPresOpen) || shouldShowScreenshare || shouldShowExternalVideo || shouldShowExtenalScreen;
    ...
    return (
      <>
        ...
        >
          ...
          {
            shouldShowExternalScreen
              ?  <ExternalScreenContainer isLayoutSwapped={!presentationIsOpen} isPresenter={isPresenter} />
              : null
          }
          {this.renderCaptions()}
          <UploaderContainer />
