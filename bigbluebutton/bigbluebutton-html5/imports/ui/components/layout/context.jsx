...
const reducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    // RTILLE Screen Share
    case ACTIONS.SET_HAS_EXTERNAL_SCREEN: {

      const { screenExternalShare } = state.input;

      if (screenExternalShare.hasScreenExternalShare === action.value) {
        return state;
      }
      return {
        ...state,
        input: {
          ...
          screenExternalShare: {
            ...screenExternalShare,
            hasScreenExternalShare: action.value,
          },
        },
      };
    }
