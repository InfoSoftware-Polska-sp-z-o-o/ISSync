...
export default function emitExternalScreenEvent(options) {
  const REDIS_CONFIG = Meteor.settings.private.redis;
  const CHANNEL = REDIS_CONFIG.channels.toAkkaApps;
  const EVENT_NAME = 'UpdateExternalScreenPubMsg';
  ...
  try {
    ...
    Logger.error(`Exception while invoking method emitExternalScreenEvent ${err.stack}`);
  }
}
